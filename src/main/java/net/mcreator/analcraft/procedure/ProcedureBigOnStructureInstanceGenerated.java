...
public class ProcedureBigOnStructureInstanceGenerated extends ElementsAnalCraft.ModElement {
	public ProcedureBigOnStructureInstanceGenerated(ElementsAnalCraft instance) {
		super(instance, 23);
	}
