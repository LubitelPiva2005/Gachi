...
public class ProcedureLejaOnStructureInstanceGenerated extends ElementsAnalCraft.ModElement {
	public ProcedureLejaOnStructureInstanceGenerated(ElementsAnalCraft instance) {
		super(instance, 30);
	}
		...
		if (((((!((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.AIR.getDefaultState().getBlock()))
			...
			if (!world.isRemote) {
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("analcraft", "lej"));
				if (template != null) {
