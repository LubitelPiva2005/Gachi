...
import net.mcreator.analcraft.procedure.ProcedureBigOnStructureInstanceGenerated;
import net.mcreator.analcraft.ElementsAnalCraft;

import java.util.Random;

@ElementsAnalCraft.ModElement.Tag
public class StructureBig extends ElementsAnalCraft.ModElement {
	public StructureBig(ElementsAnalCraft instance) {
		super(instance, 23);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 50000) {
			...
			for (int a = 0; a < count; a++) {
				...
				int z = spawnTo.getZ();
				{
					...
					ProcedureBigOnStructureInstanceGenerated.executeProcedure($_dependencies);
				}
			}
		}
	}
