...
import net.mcreator.analcraft.procedure.ProcedureLejaOnStructureInstanceGenerated;
import net.mcreator.analcraft.ElementsAnalCraft;

import java.util.Random;

@ElementsAnalCraft.ModElement.Tag
public class StructureLeja extends ElementsAnalCraft.ModElement {
	public StructureLeja(ElementsAnalCraft instance) {
		super(instance, 29);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 30000) {
			...
			for (int a = 0; a < count; a++) {
				...
				int z = spawnTo.getZ();
				{
					...
					ProcedureLejaOnStructureInstanceGenerated.executeProcedure($_dependencies);
				}
			}
		}
	}
