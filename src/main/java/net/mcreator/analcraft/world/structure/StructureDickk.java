...
import net.mcreator.analcraft.procedure.ProcedureDickkOnStructureInstanceGenerated;
import net.mcreator.analcraft.ElementsAnalCraft;

import java.util.Random;

@ElementsAnalCraft.ModElement.Tag
public class StructureDickk extends ElementsAnalCraft.ModElement {
	public StructureDickk(ElementsAnalCraft instance) {
		super(instance, 19);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 40000) {
			...
			for (int a = 0; a < count; a++) {
				...
				int z = spawnTo.getZ();
				{
					...
					ProcedureDickkOnStructureInstanceGenerated.executeProcedure($_dependencies);
				}
			}
		}
	}
