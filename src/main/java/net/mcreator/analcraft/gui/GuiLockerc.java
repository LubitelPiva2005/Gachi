...
import net.mcreator.analcraft.AnalCraft;
...
public class GuiLockerc extends ElementsAnalCraft.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiLockerc(ElementsAnalCraft instance) {
		super(instance, 25);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 12, 12) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 44, 12) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 77, 12) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 109, 12) {
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 142, 12) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 12, 48) {
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 44, 48) {
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 77, 48) {
			}));
			this.customSlots.put(8, this.addSlotToContainer(new Slot(internal, 8, 109, 48) {
			}));
			this.customSlots.put(9, this.addSlotToContainer(new Slot(internal, 9, 142, 48) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				AnalCraft.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("analcraft:textures/lockerc.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			AnalCraft.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
