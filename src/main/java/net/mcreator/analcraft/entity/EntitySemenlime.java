...
import net.mcreator.analcraft.item.ItemSemen;
import net.mcreator.analcraft.ElementsAnalCraft;

@ElementsAnalCraft.ModElement.Tag
public class EntitySemenlime extends ElementsAnalCraft.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;
	public EntitySemenlime(ElementsAnalCraft instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("analcraft", "semenlime"), ENTITYID).name("semenlime").tracker(64, 3, true).egg(-6710887, -1).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		DungeonHooks.addDungeonMob(new ResourceLocation("analcraft:semenlime"), 180);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelSlime(0), 0f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("analcraft:textures/qef.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemSemen.block, (int) (1)).getItem();
		}
