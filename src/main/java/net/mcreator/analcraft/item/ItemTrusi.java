...
public class ItemTrusi extends ElementsAnalCraft.ModElement {
	...
	public ItemTrusi(ElementsAnalCraft instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("trusilegs").setRegistryName("trusilegs").setCreativeTab(CreativeTabs.COMBAT));
	}
