...
public class BlockGrasssper extends ElementsAnalCraft.ModElement {
	@GameRegistry.ObjectHolder("analcraft:grasssper")
	public static final Block block = null;
	public BlockGrasssper(ElementsAnalCraft instance) {
		super(instance, 28);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("analcraft:grasssper", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("grasssper");
			setRegistryName("grasssper");
		}
