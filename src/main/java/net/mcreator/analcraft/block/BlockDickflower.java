...
public class BlockDickflower extends ElementsAnalCraft.ModElement {
	@GameRegistry.ObjectHolder("analcraft:dickflower")
	public static final Block block = null;
	public BlockDickflower(ElementsAnalCraft instance) {
		super(instance, 21);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("analcraft:dickflower", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("dickflower");
			setRegistryName("dickflower");
		}
